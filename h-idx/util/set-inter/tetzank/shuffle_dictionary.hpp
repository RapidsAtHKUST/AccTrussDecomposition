...
static std::array<uint8_t, 16 * 16> prepare_shuffling_dictionary() {
...
static const auto shuffle_mask_arr = prepare_shuffling_dictionary();
...
static std::array<uint32_t, 256 * 8> prepare_shuffling_dictionary_avx() {
...
static const auto shuffle_mask_avx_arr = prepare_shuffling_dictionary_avx();
