...
inline size_t intersect_scalar_branchless_c(const uint32_t *list1, size_t size1, const uint32_t *list2, size_t size2, uint32_t *result){
...
inline size_t intersect_scalar_branchless_c_count(const uint32_t *list1, size_t size1, const uint32_t *list2, size_t size2){
	size_t counter=0, pos1=0, pos2=0;
	while(pos1 < size1 && pos2 < size2){
		uint32_t data1=list1[pos1], data2=list2[pos2];
		counter += (data1 == data2);
...
inline size_t intersect_scalar_branchless(const uint32_t *list1, size_t size1, const uint32_t *list2, size_t size2, uint32_t *result){
...
inline size_t intersect_scalar_branchless_count(const uint32_t *list1, size_t size1, const uint32_t *list2, size_t size2){
