...
inline size_t intersect_vector_avx(const uint32_t *list1, size_t size1, const uint32_t *list2, size_t size2, uint32_t *result){
...
inline size_t intersect_vector_avx_count(const uint32_t *list1, size_t size1, const uint32_t *list2, size_t size2){
	size_t count=0, i_a=0, i_b=0;
#ifdef __AVX__
	size_t st_a = (size1 / 8) * 8;
	size_t st_b = (size2 / 8) * 8;
