...
def run_exp(option_tag, val_lst, env_tag=ustgpu2_tag, with_c_group=True, data_path_tag=k_truss_exec_path_tag):
    ...
    folder_name = 'exp-2019-10-06-varying-wpt-all' + os.sep + hostname
    org_order_lst = ['org']
    our_algorithm = 'pkt-varying-wpt'
    filtered_reorder_lst = org_order_lst
...
if __name__ == '__main__':
    ...
    if hostname.startswith('ustgpu2'):
        run_exp(wpt_tag, [i for i in range(65)], env_tag=ustgpu2_tag, with_c_group=False)
