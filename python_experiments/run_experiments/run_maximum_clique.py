...
def run_exp(env_tag=knl_tag, data_path_tag=exec_path_tag):
    ...
    ######################
    our_exec_path = my_config_dict[data_path_tag] + os.sep + 'tools'
    data_set_path = my_config_dict[data_set_path_tag]
    ######################

    our_exec_name_lst = ['pmc']
    ...
    folder_name = 'exp-03-11-maximum-clique'
        ...
        for data_set_name in data_set_lst:
            ...
            for our_algorithm in our_exec_name_lst:
                ...
                for t_num in thread_num_lst:
                    ...
                    params_lst = map(str,
                                     [algorithm_path,
                                      '-f', data_set_path + os.sep + data_set_name + os.sep + 'undir_edge_list.bin',
                                      '-a', '0',
